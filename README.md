...
```sh
  cd Animal-table
 https://github.com/PrinceBadru/Animal-table.git
```
-
...
- [ ] **[Appointment Scheduling: Add a feature for scheduling appointments for patients, making it easier to manage hospital operations.]**
...
If you like this project please leave a star on my repository to support me.
...
I would like to thank Microverse for providing the exercise
